...
For more details read the documentation `listings.pdf'.


Quick Installation Guide
------------------------

0) If your TeX distribution comes with an update wizard,
   package manager, or anything similar, use that program
   to install or update the package. Otherwise follow
   the steps below.
...
some days or weeks. You might want to check out the web
site:
   
   http://www.atscire.de/products/listings
